...
/**
 * Independent processing topology for a running Skynvættr.
 *
 ...
 * modules. The topology is not currently attached to [no.skasti.skynvaettr.Vaettr]; its execution
 * semantics are deliberately not prescribed here yet.
 */
