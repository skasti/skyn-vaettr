 ...
 *
 * Material, sufficiently confident model predictions become directional expectations. Expectations
 * are no longer used to bootstrap model learning: ordinary observed transitions are learned by the
 * training layer independently, while this policy only decides when a model prediction is strong
 * enough to become a persistent belief. Stability expectations remain independently configurable.
 *
